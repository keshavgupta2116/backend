...
@router.get(
    "/{group_id}/members", response_model=SuccessResponse[list[GroupMemberResponse]]
)
...
@router.post("/{group_id}/members", response_model=SuccessResponse[GroupMemberResponse])
